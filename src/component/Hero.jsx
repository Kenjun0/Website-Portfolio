    ...
    <div className="h-[100vh] w-full bg-gray-900">
      ...
      <div className="flex justify-end">
        <div className="absolute w-[85%] h-[80vh] mt-[60px] flex md:items-center items-end">
          ...
          <p className="md:text-3xl text-2xl uppercase font-mono font-semibold bg-clip-text text-transparent bg-gradient-to-l from-gray-700 to-gray-300">'Wa ragud</p>
          </div>
        </div>
